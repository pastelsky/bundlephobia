...
const categories: Record<string, CategoryDefinition> = {
  ...
  templating: {
    ...
    tags: [
      { tag: 'template', weight: Weight.NORMAL },
      { tag: 'logic', weight: Weight.MID },
      { tag: 'render', weight: Weight.NORMAL },
      { tag: 'html', weight: Weight.SMALL },
    ],
    similar: ['mustache', 'handlebars', 'pug', 'nunjucks'],
  },
  'tree-data-structures': {
    name: 'Tree data structures',
    tags: [
      { tag: 'tree', weight: Weight.HIGH },
      { tag: 'graph', weight: Weight.MID },
      { tag: 'node', weight: Weight.SMALL },
      { tag: 'data structure', weight: Weight.MID },
    ],
    similar: ['functional-red-black-tree', 'suffix-tree', 'bin-tree'],
  },
  'url-manipulation': {
    name: 'URL parsing and manipulation',
    tags: [
      { tag: 'url', weight: Weight.HIGH },
      { tag: 'parse', weight: Weight.NORMAL },
      { tag: 'hostname', weight: Weight.NORMAL },
      { tag: 'domain', weight: Weight.NORMAL },
      { tag: 'path', weight: Weight.NORMAL },
      { tag: 'query', weight: Weight.NORMAL },
      { tag: 'scheme', weight: Weight.NORMAL },
      { tag: 'string', weight: Weight.SMALL },
    ],
    similar: ['url-parse', 'normalize-url', 'normalize-path'],
  },
  'virtual-dom': {
    name: 'Virtual DOM libraries',
    tags: [
      { tag: 'virtual', weight: Weight.HIGH },
