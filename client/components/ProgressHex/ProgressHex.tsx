import React, { Component, useEffect, useReducer, useRef } from 'react'
...
export function ProgressHex({ compact }: ProgressHexProps) {
  const svgRef = useRef<SVGSVGElement | null>(null)

  useEffect(() => {
    const animator = new ProgressHexAnimator({ svg: svgRef.current! })
